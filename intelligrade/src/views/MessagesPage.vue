...
const fetchConversations = () => {
  conversations.value = [
    { 
      id: 1, 
      sender: 'Student A', 
      lastMessage: 'Hi, I need help with my homework assignment for tomorrow.', 
      time: '10:30 AM', 
      read: false, 
      messages: [
        { id: 1, text: 'Maam, I need help with my homework assignment for tomorrow.', sender: 'Student A', time: '10:28 AM' },
        { id: 2, text: 'Sure, what do you need help with?', sender: 'You', time: '10:30 AM' },
      ]
    },
    { 
      id: 2, 
      sender: 'Student B', 
      lastMessage: 'Maam, when is the deadline for the project submission?', 
      time: 'Yesterday', 
      read: false, 
      messages: [
        { id: 3, text: 'Maam, when is the deadline for the project submission?', sender: 'Student B', time: 'Yesterday' },
      ]
    },
    { 
      id: 3, 
      sender: 'Student C', 
      lastMessage: 'Thank you for grading my quiz! I really appreciate the feedback.', 
      time: 'Tuesday', 
      read: true,
      messages: [
        { id: 4, text: 'Thank you for grading my quiz! I really appreciate the feedback.', sender: 'Student C', time: 'Tuesday' },
        { id: 5, text: 'You\'re welcome! Keep up the good work.', sender: 'You', time: 'Tuesday' },
      ]
    },
    { 
      id: 4, 
      sender: 'Student D', 
      lastMessage: 'I will be absent today due to sickness. I\'ll get the notes from my classmate.', 
      time: '3 days ago', 
      read: true,
      messages: [
        { id: 6, text: 'Maam, I will be absent today due to sickness. I\'ll get the notes from my classmate.', sender: 'Student D', time: '3 days ago' },
      ]
    },
    { 
      id: 5, 
      sender: 'Student E', 
      lastMessage: 'Good day! What is the topic of our next test?', 
      time: '1 week ago', 
      read: true,
      messages: [
        { id: 7, text: 'Good day! What is the topic of our next test?', sender: 'Student E', time: '1 week ago' },
        { id: 8, text: 'Hello, the topic for the next test is...', sender: 'You', time: '1 week ago' },
      ]
    },
  ];
};
...
const toggleReadStatus = (id) => {
  ...
  activeMessageMenu.value = null; // Close menu after action
};
...
const openConversationModal = (convo) => {
  ...
  convo.read = true; // Mark as read when opening
...
const closeModal = () => {
  ...
  newMessage.value = '';
  activeMessageMenu.value = null; // Close any open menu
};
...
const sendMessage = () => {
  ...
  activeConversation.value.lastMessage = newMsg.text;
  newMessage.value = '';
  ...
  setTimeout(() => {
    const replyMsg = {
      id: Date.now() + 1,
      text: "Thank you for the reply! Got it.",
      sender: activeConversation.value.sender,
      time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    };
    activeConversation.value.messages.push(replyMsg);
    activeConversation.value.lastMessage = replyMsg.text;
    
    // Scroll to the bottom again after the reply arrives
    nextTick(() => {
      if (messagesContainer.value) {
        messagesContainer.value.scrollTop = messagesContainer.value.scrollHeight;
      }
